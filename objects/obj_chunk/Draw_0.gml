	...
	for (var _y = _miny; _y < _maxy; _y++) {
		for (var _x = _minx; _x < _maxx; _x++) {
			...
			if (_cell) {
				...
				draw_sprite_part(spr_mars_32_161, 0, ((_ind[0]) % 4) * _gsz, (_ind[0] div 4) * _gsz, _gsz, _gsz, x + _x * grid_size - _cx,		  y + _y * grid_size - _cy);
				draw_sprite_part(spr_mars_32_161, 0, ((_ind[1]) % 4) * _gsz, (_ind[1] div 4) * _gsz, _gsz, _gsz, x + _x * grid_size - _cx + _gsz, y + _y * grid_size - _cy);
				draw_sprite_part(spr_mars_32_161, 0, ((_ind[2]) % 4) * _gsz, (_ind[2] div 4) * _gsz, _gsz, _gsz, x + _x * grid_size - _cx,		  y + _y * grid_size - _cy + _gsz);
				draw_sprite_part(spr_mars_32_161, 0, ((_ind[3]) % 4) * _gsz, (_ind[3] div 4) * _gsz, _gsz, _gsz, x + _x * grid_size - _cx + _gsz, y + _y * grid_size - _cy + _gsz);
			...
			if (_cell >= 2) {
				draw_sprite(ore_sprite[_cell - 2], 0, x + _x * grid_size - _cx, y + _y * grid_size - _cy);	
			}
		}
	}
